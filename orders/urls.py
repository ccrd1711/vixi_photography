...
urlpatterns = [
    ...
    path("cart/remove/<int:photo_id>/<str:variant>/", views.remove_one,
         name="remove_one"),
    ...
    path("bookings/<int:pk>/delete/", views.delete_booking,
         name="delete_booking"),
    path("booking/success/<int:pk>/", views.booking_success,
         name="booking_success"),
    path("booking/cancel/<int:pk>/", views.booking_cancel,
         name="booking_cancel"),
    path("orders/", views.my_orders, name="my_orders"),
    path("download/<int:item_id>/", views.download_item,
         name="orderitem_download"),
]
